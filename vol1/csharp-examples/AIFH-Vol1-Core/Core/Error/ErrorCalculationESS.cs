...
{
    /// <summary>
    /// The sum of squares method (ESS) measures the error as the sum of the squared difference of each 
    /// vector element.
    ///
    /// http://www.heatonresearch.com/wiki/Sum_of_Squares_Error
    /// </summary>
    public class ErrorCalculationESS : AbstractErrorCalculation
    {
        /// <summary>
