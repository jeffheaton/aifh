 ...
 * @param offspringProduced The number of offspring produced by this type of crossover.
 * @param parentsNeeded The number of parents needed.
 */
abstract class EvolutionaryOperator(val owner : EvolutionaryAlgorithm,
                                     val offspringProduced : Int,val parentsNeeded : Int) {
   ...
   */
  def performOperation(rnd: GenerateRandom, parents: Array[Genome], parentIndex: Int,
