 ...
 */
trait ErrorCalculation {
  /**
   * @return A new instance of this object.
   */
  def create: ErrorCalculation
   ...
   */
  def updateError(actual: Array[Double], ideal: Array[Double], significance: Double)
   ...
   */
  def updateError(actual: Double, ideal: Double)
