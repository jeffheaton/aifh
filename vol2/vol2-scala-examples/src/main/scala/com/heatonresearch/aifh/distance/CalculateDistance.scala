...
trait CalculateDistance {
   ...
   * @return The distance.
   */
  def calculate(position1: Array[Double], position2: Array[Double]): Double
   ...
   * @return The distance.
   */
  def calculate(position1: Array[Double], pos1: Int, position2: Array[Double], pos2: Int, length: Int): Double
}