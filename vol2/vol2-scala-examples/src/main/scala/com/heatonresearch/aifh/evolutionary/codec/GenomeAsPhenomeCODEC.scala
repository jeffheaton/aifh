 ...
 */
class GenomeAsPhenomeCODEC extends GeneticCODEC {

  override def decode(genome: Genome): MLMethod = genome

  override def encode(phenotype: MLMethod): Genome = phenotype.asInstanceOf[Genome]
}