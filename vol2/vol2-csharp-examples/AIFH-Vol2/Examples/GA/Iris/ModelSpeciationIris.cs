...
{
    /// <summary>
    ///     Learn the Iris data set with a RBF network trained by a genetic algorithm, use species.
    /// </summary>
    public class ModelSpeciationIris : SimpleLearn
    {
        /// <summary>
        ...
        {
            var solve = new ModelSpeciationIris();
            solve.Process();
        }
