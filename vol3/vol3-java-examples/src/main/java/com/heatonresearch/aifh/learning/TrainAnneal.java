...
public class TrainAnneal implements LearningMethod {
     ...
     */
    private final MLMethod algorithm;
     ...
     */
    public TrainAnneal(final MLMethod theAlgorithm, final ScoreFunction theScore) {
     ...
     */
    public TrainAnneal(final MLMethod theAlgorithm, final ScoreFunction theScore, final int theKMax, final double theStartingTemperature, final double theEndingTemperature) {
