...
namespace AIFH_Vol3_Core.Core.SOM.Train
{
    ...
    public class BasicTrainSOM
    {
        ...
        /// should be "trained".
        /// </summary>
        private INeighborhoodFunction _neighborhood;
        ...
        /// </summary>
        private SelfOrganizingMap _network;
        ...
        /// </summary>
        private BestMatchingUnit _bmuUtil;

        /// <summary>
        /// Holds the corrections for any matrix being trained.
        /// </summary>
        private Matrix _correctionMatrix;
        ...
        private void ApplyCorrection()
        {
            ...
            for (int row = 0; row < _correctionMatrix.RowCount; row++)
            {
                for (int col = 0; col < _correctionMatrix.ColumnCount; col++)
                {
        ...
        private bool ForceWinners(Matrix matrix, int[] won, double[] leastRepresented)
        {
            ...
            double[] output = Compute(_network, leastRepresented);
        ...
        public void Iteration()
        {
            ...
            _bmuUtil.Reset();
            int[] won = new int[_outputNeuronCount];
            ...
            foreach (BasicData input in _training)
            {
                int bmu = _bmuUtil.CalculateBMU(input.Input);
                won[bmu]++;
                ...
                if (ForceWinner)
                {
                    ...
                    double[] output = Compute(_network, input.Input);
                                  ...
                                  int current, int bmu)
        {
            ...
            for (int inputNeuron = 0; inputNeuron < _inputNeuronCount; inputNeuron++)
            {
                ...
                double currentWeight = matrix[current, inputNeuron];
        ...
        {
            int bmu = _bmuUtil.CalculateBMU(pattern);
