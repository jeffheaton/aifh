...
namespace AIFH_Vol3_Core.Core.Selection
{
    ...
    public abstract class ModelSelection
    {
        ...
        ///     The axes.
        /// </summary>
        private readonly IList<ISearchAxis> searchAxises = new List<ISearchAxis>();
        ...
        {
            searchAxises.Add(new NumericSearchAxis(start, stop, step));
        }
        ...
        {
            searchAxises.Add(new CategorySearchAxis(list));
        }
